...
| High | **TM-016 — Build or release supply chain publishes attacker-controlled code.** ACT-SUPPLY gains consumer or production execution. | Mutable action/tag/dependency, overprivileged CI, leaked signer, local release, or unverifiable artifact | All-workspace control-plane compromise and credential access | Bootstrap and CI tools are checksum-pinned; workflows use locked full-SHA actions and least-privilege jobs; strict review/check policy, dependency/secret/static/license/IaC scans, 30-day source SBOM retention, and exact-source GitHub attestations are implemented; release artifacts are absent | Preserve protected exact-head review and scan evidence; implement reproducible release binaries/images, separate signing identity, publication, release SBOM/provenance, and consumer verification | Follow-up: Issue #66; verification: Issues #15 and #66 |
